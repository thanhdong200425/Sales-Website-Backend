 ...
 */
export const getOrderHistoryByUserId = async (userId: number): Promise<OrderHistoryItem[]> => {
  try {
 ...
 */
export const getOrderHistoryDetail = async (orderId: number, userId: number): Promise<OrderDetailResponse | null> => {
  try {
