...
async function seedNotifications() {
    console.info("Seeding sample notifications...");

    const user = await prisma.user.findFirst();
    if (!user) {
        console.warn("No user found; skipping notification seed.");
        return;
    }
    ...
    const sampleNotifications = [
        {
            title: "Order placed",
            message: "You placed order #254845",
            imageUrl:
                "https://images.unsplash.com/photo-1473181488821-2d23949a045a?auto=format&fit=crop&w=400&q=80",
        },
        {
            title: "Order shipped",
            message: "Order #478541 is on the way",
            imageUrl:
                "https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?auto=format&fit=crop&w=400&q=80",
        },
        {
            title: "Delivery update",
            message: "Package for order #26448 arrived at facility",
            imageUrl:
    ...
    console.info("Sample notifications seeded.");
}
